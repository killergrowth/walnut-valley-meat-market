'use strict';
// build-forms.js ΓÇö beef and pork cutting order form HTML generators
...
function beefForm() {
  const qty = `<div class="grid grid-cols-2 md:grid-cols-4 gap-3">
  <button type="button" class="qty-card" data-beef-qty="whole"><div class="font-bold">Whole</div><div class="text-xs text-stone-500">~700 lbs</div><div class="text-sm font-semibold text-red-700 mt-1">$5.99/lb</div><div class="border-t border-stone-200 mt-2 pt-2"><div class="text-xs text-blue-700">~420 lbs take-home</div><div class="text-xs text-cyan-700">14-18 cu ft freezer</div><div class="text-xs text-stone-500">Est. ~$4,193</div></div></button>
  <button type="button" class="qty-card selected" data-beef-qty="half"><div class="font-bold">Half</div><div class="text-xs text-stone-500">~350 lbs</div><div class="text-sm font-semibold text-red-700 mt-1">$5.99/lb</div><div class="border-t border-stone-200 mt-2 pt-2"><div class="text-xs text-blue-700">~180 lbs take-home</div><div class="text-xs text-cyan-700">8-10 cu ft freezer</div><div class="text-xs text-stone-500">Est. ~$2,097</div></div></button>
  <button type="button" class="qty-card" data-beef-qty="quarter"><div class="font-bold">Quarter</div><div class="text-xs text-stone-500">~175 lbs</div><div class="text-sm font-semibold text-red-700 mt-1">$6.50/lb</div><div class="border-t border-stone-200 mt-2 pt-2"><div class="text-xs text-blue-700">~105 lbs take-home</div><div class="text-xs text-cyan-700">4-6 cu ft freezer</div><div class="text-xs text-stone-500">Est. ~$1,138</div></div></button>
  <a href="https://square.link/u/k1Bvfozw" target="_blank" rel="noopener" class="qty-card flex flex-col items-center justify-between" style="text-decoration:none;border:2px solid #b91c1c;"><div class="font-bold text-stone-800">1/8th Beef</div><div class="text-xs text-stone-500">~50 lbs</div><div class="text-sm font-semibold text-red-700 mt-1">$599 flat</div><div class="border-t border-stone-200 mt-2 pt-2 w-full text-center"><div class="text-xs text-stone-500 mb-2">Pre-selected cuts included</div><span style="display:inline-block;background:#b91c1c;color:#fff;font-size:0.75rem;font-weight:700;padding:6px 16px;border-radius:6px;letter-spacing:0.05em;">ORDER NOW</span></div></a>
</div>`;
  ...
  const round = `<p class="text-xs text-stone-500 mb-3 italic">Choose one option below:</p>` +
    ...
    `<div id="round-rump-wrap" style="display:none"><div class="border-t border-stone-200 mt-3 pt-3"><p class="text-xs text-stone-500 mb-2 italic">Also available (choose one or both ΓÇö Whole &amp; Half orders only). If not selected, these will be added to your ground beef.</p>` +
  ...
  return fsec(2,'Select Quantity','','',qty,true) +
    ...
    fsec(7,'Round Section','[{"term":"Round Steak","description":"Lean rear-leg steak. Best braised or sliced thin."},{"term":"Tenderized Round Steak","description":"Mechanically tenderized - great for chicken-fried steak."},{"term":"Minute Steak","description":"Thin-sliced, cooks in under a minute."},{"term":"Round Roast","description":"Large lean roast from the top round. Best slow-roasted or braised."},{"term":"Rump Roast","description":"A well-marbled roast from the hindquarters. Best slow-roasted in a Dutch oven or slow cooker ΓÇö falls apart tender when braised. Common sizes: 3ΓÇô6 lbs. Available for Whole and Half orders only."},{"term":"Pikes Peak Roast","description":"A flavorful, economical roast cut from the lower round (heel). Dense muscle that becomes very tender with long, slow moist-heat cooking ΓÇö great for shredded beef or pot roast. Common sizes: 3ΓÇô6 lbs. Available for Whole and Half orders only."},{"term":"Grind","description":"Added to ground beef. Very lean."}]','Lean rear-leg muscle.',round,false) +
    fsec(8,'Chuck Section','[{"term":"Chuck Roast","description":"Classic pot roast cut from the shoulder. Incredible when braised low and slow ΓÇö rich, beefy flavor. Common sizes: 2ΓÇô5 lbs."},{"term":"Arm Roast","description":"A slightly leaner round-bone roast from the shoulder. Great for pot roast and braised dishes. Slightly firmer texture than chuck. Common sizes: 2ΓÇô5 lbs."}]','Great for pot roast.',chuck,false) +
    ...
    fsec(10,'Ribs and Soup Bones','[{"term":"Beef Ribs ΓÇö Save","description":"The beef back ribs are packaged for you. Great for smoking or slow-cooking."},{"term":"Beef Ribs ΓÇö Grind","description":"The rib meat is trimmed off and added to your ground beef."},{"term":"Soup Bones ΓÇö Save","description":"Marrow-rich bones sliced to about 1.25\\" thick. Perfect for making rich bone broth, stock, or soups."},{"term":"Soup Bones ΓÇö Grind","description":"The meat around the bones is trimmed off and added to your ground beef."}]','Ribs are great for BBQ. Soup bones make rich bone broth.',ribssoup,false) +
    fsec(11,'Ground Beef Settings','[{"term":"80% Lean (Standard)","description":"Standard ground beef with 20% fat. The most flavorful option and best yield. Great for burgers, meat sauce, and most recipes."},{"term":"85% Lean","description":"Slightly leaner with 15% fat. A good middle ground ΓÇö less shrinkage than 80% but still flavorful."},{"term":"90% Lean","description":"Very lean ground beef. Less flavor and more shrinkage when cooked, but preferred for low-fat diets."},{"term":"1 lb packages","description":"Each package contains 1 pound of ground beef. Good for smaller households or single meals."},{"term":"2 lb packages","description":"Each package contains 2 pounds of ground beef. Great for larger families or batch cooking."}]','These settings apply to ALL items sent to grind.',grind,false) +
