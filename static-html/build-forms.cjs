...
function beefForm() {
  ...
  const round = radio('beef-round','rnd-steak','steak','Round Steak',true) +
    ...
    `<div id="round-rump-wrap" style="display:none">` +
    radio('beef-round','rnd-rump','rump','Rump Roast',false) +
    `<div class="ml-6 mt-1 mb-1"><label class="text-xs text-stone-600">Roast Size</label>${sel('beef-rnd-rump',['3-4 lb','4-5 lb','5-6 lb'],'4-5 lb')}</div>` +
    `</div>` +
    `<div id="round-pikes-wrap" style="display:none">` +
    radio('beef-round','rnd-pikes','pikes','Pikes Peak Roast',false) +
    `<div class="ml-6 mt-1 mb-1"><label class="text-xs text-stone-600">Roast Size</label>${sel('beef-rnd-pikes',['3-4 lb','4-5 lb','5-6 lb'],'4-5 lb')}</div>` +
    `</div>` +
